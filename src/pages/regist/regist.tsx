...
class Index extends PureComponent {
  ...
  onSubmit = () => {
    const { selectorCheckedId, userName, password, code } = this.state;
    ...
    console.log(selectorCheckedId, userName, password, code);
  }
    ...
    return (
      <View className="wrapper">
        ...
        <View className="container">
          ...
          <AtButton formType='submit' type="primary" onClick={this.onSubmit}>注册</AtButton>
        </View>
      </View>
    );
  }
